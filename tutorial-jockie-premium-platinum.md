...
Per 16 April 2026, paket **Platinum Supporter** Jockie Music tersedia di Patreon dengan harga **US$10/bulan**.

Benefit yang terlihat publik di halaman tier tersebut:

- Mendapat **10 Jockie Music boosts**.
- **All-time statistics** aktif dengan **1 boost**.
- **Audio filters** aktif dengan **2 boosts**.
- Fitur **24/7** aktif dengan **5 boosts**.
- Dengan **10 boosts**, server bisa mendapat total **3 additional premium bots**.
- Akses role supporter dan channel supporter di server support Jockie.
- Bisa membuat sampai **200 custom playlists (collections)**, masing-masing sampai **10.000 track**.
...
## Langkah 1 — Buka Halaman Membership Jockie
...
- Patreon kadang menampilkan opsi **monthly** atau **annual** jika kreator mengaktifkannya.
- Tagihan final bisa berbeda karena **pajak/VAT** atau konversi mata uang.
...
1. Login ke Patreon.
2. Buka **Settings**.
3. Masuk ke **More** lalu **Connected Apps**.
4. Pilih **Discord** lalu klik **Connect**.
5. Login ke akun Discord yang benar.
6. Klik **Authorize**.
...
## Langkah 4 — Pastikan Membership Platinum Sudah Aktif
...
- Patreon dan Discord sudah sempat sinkron ulang.

---

## Langkah 5 — Gunakan 10 Boost Jockie Music

Benefit utama Platinum adalah **10 Jockie Music boosts**. Boost ini dipakai untuk membuka fitur premium di server.

Yang sudah terverifikasi dari halaman tier:

| Jumlah Boost di Server | Benefit yang Terbuka |
|---|---|
| 1 boost | All-time statistics |
| 2 boosts | Audio filters |
| 5 boosts | Fitur 24/7 |
| 10 boosts | Total 3 additional premium bots |
...
3. Disconnect lalu reconnect Discord di Patreon.
4. Logout Discord, lalu login ulang jika sinkronisasi terasa macet.
5. Refresh Patreon dan Discord.

### 2) Tidak dapat role atau akses Discord
...
- Saldo cukup.
- Kartu atau metode bayar belum expired.
- Transaksi online, aman, dan recurring diizinkan.
- Jika tetap gagal, coba metode pembayaran lain.
...
- Jockie Music: [https://www.jockiemusic.com/](https://www.jockiemusic.com/)
- Patreon Jockie Membership: [https://www.patreon.com/Jockie/join](https://www.patreon.com/Jockie/join)
- Patreon Help — Getting Discord access: [https://support.patreon.com/hc/en-us/articles/212052266-Getting-Discord-access](https://support.patreon.com/hc/en-us/articles/212052266-Getting-Discord-access)
- Patreon Help — Joining a creator’s Patreon as a paid member: [https://support.patreon.com/hc/en-us/articles/203913709-Joining-a-creator-s-Patreon-as-a-paid-member](https://support.patreon.com/hc/en-us/articles/203913709-Joining-a-creator-s-Patreon-as-a-paid-member)
- Patreon Help — How membership billing works: [https://support.patreon.com/hc/en-us/articles/360002355991-How-membership-billing-works](https://support.patreon.com/hc/en-us/articles/360002355991-How-membership-billing-works)
